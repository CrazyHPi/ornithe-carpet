...
public interface CarpetRule<T> {
    ...
    /**
     * <p>Returns a {@link List} of {@link Text} with extra information about this rule, that is,
     ...
     *
     * <p>This value will never be {@code null}, and will always be a valid value for {@link #set(CommandSource, Object)}.</p>
     */
    T defaultValue();
     ...
     * {@link SettingsManager#notifyRuleChanged(CommandSource, CarpetRule, String)}, who is responsible for notifying the
     * {@link carpet.network.ServerNetworkHandler} (if the rule isn't restricted from being synchronized with clients) and other rule observers like the Scarpet
     ...
     *
     * @param source The {@link CommandSource} to notify about the result of this rule change or {@code null} in order to not notify
    ...
    /**
     * <p>This method follows the same contract as {@link #set(CommandSource, String)}, but accepts a value already parsed (though not verified).</p>
     *
     * @see #set(CommandSource, String)
     */
