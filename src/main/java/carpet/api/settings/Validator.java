 ...
 * @see #validate(CommandSource, CarpetRule, Object, String)
 */
public abstract class Validator<T> {
     ...
     *
     * @param source       The {@link CommandSource} that originated this change, and should be further notified
     ...
     */
    public abstract T validate(@Nullable CommandSource source, CarpetRule<T> changingRule, T newValue, String userInput);
    ...
    /**
     * <p>Called after failing validation of the {@link CarpetRule} in order to notify the causing {@link CommandSource} about the
     * failure.</p>
     *
     * @param source        The {@link CommandSource} that originated this change. It will never be {@code null}
